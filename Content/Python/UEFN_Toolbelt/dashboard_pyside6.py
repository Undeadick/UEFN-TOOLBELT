...
def _tab_quick_actions(R) -> "QScrollArea":
    ...
    if not os.path.exists(_cfg_path):
        banner = QLabel(
            ...
            "or browse any tab to explore all 367 tools. "
...
def _tab_mcp(R) -> "QScrollArea":
    ...
    info = QLabel(
        ...
        "Your AI can then run all 367 tools, spawn/move actors,\n"
...
def _tab_about(_R=None) -> "QScrollArea":
    ...
    version = QLabel(f"v{_tbv}  ·  367 tools  ·  UEFN 40.00+  ·  Python 3.11  ·  March 2026")
    ...
    for name, desc, url in [
        ...
        (
            "BiomeForge  (EDMIRE2k)",
            "Cooker Optimizer concept — UEFNCookerOptimizer. "
            "Full credit for the editor-only batching workflow and confidence "
            "estimation algorithm for working around UEFN cooker OOM failures.",
            "https://github.com/EDMIRE2k/UEFNCookerOptimizer",
        ),
    ]:
