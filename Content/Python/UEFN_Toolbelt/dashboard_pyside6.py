...
def _tab_quick_actions(R) -> "QScrollArea":
    ...
    if not os.path.exists(_cfg_path):
        banner = QLabel(
            ...
            "or browse any tab to explore all 371 tools. "
...
def _tab_mcp(R) -> "QScrollArea":
    ...
    info = QLabel(
        ...
        "Your AI can then run all 371 tools, spawn/move actors,\n"
...
def _tab_about(_R=None) -> "QScrollArea":
    ...
    version = QLabel(f"v{_tbv}  ·  371 tools  ·  UEFN 40.00+  ·  Python 3.11  ·  March 2026")
