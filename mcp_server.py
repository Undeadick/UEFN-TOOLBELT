...
After that, Claude Code has full control over UEFN — 367 tools, live actor data,
arbitrary Python execution, viewport control, and more.

What this exposes (beyond Kirch's original 22 tools):
    run_toolbelt_tool   — call any of the 367 registered toolbelt tools by name
...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "  import UEFN_Toolbelt as tb; tb.run('mcp_start')\n\n"
        "Key tools:\n"
        "  run_toolbelt_tool   — run ANY of the 367 registered toolbelt tools\n"
...
def run_toolbelt_tool(tool_name: str, kwargs: dict | None = None) -> str:
    ...
    This is the single most powerful MCP tool — it exposes all 367 toolbelt tools
